...
-- ============================================================
-- ATTENDANCE — one record per labour per date
-- ============================================================
...
create table public.advances (
    id            uuid primary key default gen_random_uuid(),
    site_id       uuid not null references public.sites(id) on delete restrict,
    labour_id     uuid not null references public.labour(id) on delete restrict,
...
-- ============================================================
-- LABOUR PAYMENTS — actual payments made to labourers
-- ============================================================
...
-- ============================================================
-- MATERIAL PURCHASES — purchase header
-- ============================================================
